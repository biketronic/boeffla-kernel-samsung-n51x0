...
# disabled for n5120 version as this device has no notification led
if [ "param_led" == "$1" ]; then
	exit 0
fi
...
if [ "apply_governor_profile" == "$1" ]; then
	...
	if [ "pegasusq - boeffla 1 core" == "$2" ]; then
		...
		echo "4000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_1_1
		echo "4000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_2_0
		# cpu3
		echo "1600000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_2_1
		echo "1500000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_3_0
		echo "5000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_2_1
		echo "5000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_3_0
		# cpu4
		echo "1600000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_3_1
		echo "1500000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_4_0
		echo "6000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_3_1
		echo "6000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_4_0
	...
	if [ "pegasusq - boeffla battery saving" == "$2" ]; then
		...
		echo "1600000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_1_1
		echo "1500000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_2_0
		echo "600" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_1_1
		echo "600" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_2_0
		# cpu3
		echo "1600000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_2_1
		echo "1500000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_3_0
		echo "650" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_2_1
		echo "650" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_3_0
		# cpu4
		echo "1600000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_3_1
		echo "1500000" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_freq_4_0
		echo "700" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_3_1
		echo "700" > /sys/devices/system/cpu/cpufreq/pegasusq/hotplug_rq_4_0

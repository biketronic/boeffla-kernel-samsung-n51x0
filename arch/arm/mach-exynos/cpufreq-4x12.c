...
//BIKETRONIC GOV: 2000Mhz support
// NOTE
// Because of DIV 8 limit:
// COREM1 is overclocked over 1500Mhz
// COREM0 is fine, if you limit to 4, OCs at 1600
// ATB OCs at 1800 
// PLL OCs at 1704
// REDUCED 1600MHZ due to much higher power consumption div ATB & M0
// REDUCED 1920 & 2000MHZ M0 because it's possible. Probably makes no diff.
static unsigned int clkdiv_cpu0_4412[CPUFREQ_LEVEL_END][8] = {
	 ...
	 */
	/* ARM L0: 2000Mhz */
	/* reduced coreM0 from 400 (350 max) to 333 */
	/* makes no difference, even tried changing masks, still unstable */
	/* was 0-4-707170 */
	{ 0, 4, 7, 0, 7, 1, 7, 0 },

	/* ARM L1: 1920Mhz */
	/* can only reduce COREM0 -> 350 MAX, was 384, now 320 */
	/* was 0-4-707170 */
	{ 0, 4, 7, 0, 7, 1, 7, 0 },

	/* ARM L2: 1800Mhz */
	/*coreM0 could be reduced, is slightly OC */
	{ 0, 4, 7, 0, 7, 1, 7, 0 },
	...
	/* ARM L4: 1600Mhz */
	/* can changed from 0-3-70-6-17 to slower */
	/* slightly OC (400>350 -> 320, 229>214 -> 200) */
	/* difference is 25mV UV, hardly worth it */
	{ 0, 3, 7, 0, 6, 1, 7, 0 },
...
//BIKETRONIC GOV: 2000Mhz support
// shift is 4 bits per group, should support up to 1111 = 15?
// But mask is 0x7, all documentation suggests >7 is not supported.
...
static const unsigned int asv_voltage_step_12_5_rev2[CPUFREQ_LEVEL_END][13] = {
	/*   ASV0,    ASV1,    ASV2,    ASV3,	 ASV4,	  ASV5,	   ASV6,    ASV7,    ASV8,    ASV9,   ASV10,   ASV11    ASV12 */
	{ 1500000, 1500000, 1500000, 1500000, 1500000, 1500000,	1500000, 1500000, 1500000, 1500000, 1500000, 1500000, 1500000 }, /* L0 2000MHz */
	{ 1450000, 1425000, 1425000, 1425000, 1425000, 1425000, 1425000, 1400000, 1400000, 1400000, 1400000, 1375000, 1375000 }, /* L1 1920 */
	{ 1425000, 1400000, 1400000, 1400000, 1400000, 1400000, 1400000, 1375000, 1375000, 1375000, 1375000, 1350000, 1350000 }, /* L2 1800 */
	{ 1400000, 1375000, 1375000, 1375000, 1375000, 1375000, 1375000, 1350000, 1350000, 1350000, 1350000, 1325000, 1325000 }, /* L3 1704 */
	{ 1312500, 1300000, 1300000, 1300000, 1300000, 1287500, 1275000, 1262500, 1250000, 1237500, 1212500, 1200000, 1187500 }, /* L4 1600 */
	{ 1312500, 1250000, 1250000, 1250000, 1250000, 1237500, 1225000, 1212500, 1200000, 1187500, 1162500, 1150000, 1137500 }, /* L5 1500 */
	{ 1275000, 1225000, 1225000, 1225000, 1212500, 1200000, 1187500, 1175000, 1162500, 1150000, 1125000, 1112500, 1100000 }, /* L6 1400 */
	{ 1225000, 1175000, 1175000, 1175000, 1162500, 1150000, 1137500, 1125000, 1112500, 1100000, 1075000, 1062500, 1050000 }, /* L7 1300 */
	{ 1187500, 1150000, 1150000, 1150000, 1125000, 1112500, 1100000, 1087500, 1075000, 1062500, 1037500, 1025000, 1012500 }, /* L8 1200 */
	{ 1150000, 1125000, 1125000, 1125000, 1087500, 1075000, 1062500, 1050000, 1037500, 1025000, 1000000,  987500,  975000 }, /* L9 1100 */
	{ 1125000, 1100000, 1100000, 1100000, 1062500, 1050000, 1037500, 1025000, 1012500, 1000000,  975000,  962500,  950000 }, /* L10 1000 */
	{ 1100000, 1075000, 1075000, 1075000, 1037500, 1025000, 1012500, 1000000,  987500,  975000,  950000,  937500,  925000 }, /* L11 900 */
	{ 1062500, 1050000, 1050000, 1050000, 1000000,  987500,  975000,  962500,  950000,  937500,  912500,  900000,  887500 }, /* L12 800 */
	{ 1037500, 1025000, 1025000,  987500,  975000,  962500,  950000,  937500,  925000,  912500,  887500,  887500,  887500 }, /* L13 700 */
	{ 1012500, 1000000, 1000000,  962500,  950000,  937500,  925000,  912500,  900000,  887500,  875000,  875000,  875000 }, /* L14 600 */
	{ 1000000,  975000,  975000,  950000,  937500,  925000,  912500,  900000,  887500,  887500,  875000,  875000,  875000 }, /* L15 500 */
	{  987500,  950000,  950000,  937500,  925000,  912500,  900000,  887500,  887500,  887500,  875000,  875000,  875000 }, /* L16 400 */
	{  975000,  925000,  925000,  925000,  912500,  900000,  887500,  887500,  887500,  887500,  875000,  875000,  875000 }, /* L17 300 */
	{  962500,  900000,  900000,  900000,  900000,  887500,  887500,  887500,  887500,  887500,  875000,  875000,  875000 }, /* L18 200 */
	{  925000,  875000,  875000,  875000,  875000,  850000,  850000,  850000,  850000,  850000,  850000,  850000,  850000 }, /* L19 100 */
};
...
int exynos4x12_cpufreq_init(struct exynos_dvfs_info *info)
{
	...
	for (i = L0; i <  CPUFREQ_LEVEL_END; i++) {
		...
		if (soc_is_exynos4212()) {
			...
			tmp |= ((clkdiv_cpu0_4412[i][0] << EXYNOS4_CLKDIV_CPU0_CORE_SHIFT) | //0 mask 0x7
				(clkdiv_cpu0_4412[i][1] << EXYNOS4_CLKDIV_CPU0_COREM0_SHIFT) | //4mask 0x7
				(clkdiv_cpu0_4412[i][2] << EXYNOS4_CLKDIV_CPU0_COREM1_SHIFT) | //8mask 0x7
				(clkdiv_cpu0_4412[i][3] << EXYNOS4_CLKDIV_CPU0_PERIPH_SHIFT) | //12mask 0x7
				(clkdiv_cpu0_4412[i][4] << EXYNOS4_CLKDIV_CPU0_ATB_SHIFT) | //16mask 0x7
				(clkdiv_cpu0_4412[i][5] << EXYNOS4_CLKDIV_CPU0_PCLKDBG_SHIFT) | //20mask 0x7
				(clkdiv_cpu0_4412[i][6] << EXYNOS4_CLKDIV_CPU0_APLL_SHIFT) | //24mask 0x7
				(clkdiv_cpu0_4412[i][7] << EXYNOS4_CLKDIV_CPU0_CORE2_SHIFT)); //28mask 0x7
		}
		...
		if (soc_is_exynos4212()) {
			...
			tmp |= ((clkdiv_cpu1_4412[i][0] << EXYNOS4_CLKDIV_CPU1_COPY_SHIFT) | // 0 mask 0x7
				(clkdiv_cpu1_4412[i][1] << EXYNOS4_CLKDIV_CPU1_HPM_SHIFT) |  // 4
				(clkdiv_cpu1_4412[i][2] << EXYNOS4_CLKDIV_CPU1_CORES_SHIFT)); // 8 mask 0x7
		}
